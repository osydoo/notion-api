<template>
  <div class="numbered_list_item-wrapper">
    <div class="numbered_list_item">
      <template v-for="(item, index) in content.numbered_list_item.rich_text"
        ><a
          v-if="item.href !== null"
          :key="'a-' + index"
          :href="item.href"
...
.numbered_list_item-wrapper > a {
  color: rgb(55, 53, 47);
}
.numbered_list_item-wrapper > a,
.numbered_list_item-wrapper > span .code-style {
  line-height: normal;
